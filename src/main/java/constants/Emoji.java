...
public class Emoji {
    ...
    public final static String GUILD_ONLINE = EmojiParser.parseToUnicode("<:Online:311276612744118277>");
    public final static String GUILD_IDLE = EmojiParser.parseToUnicode("<:Idle:311276612715020288>");
    public final static String GUILD_DND = EmojiParser.parseToUnicode("<:DnD:311276612706369556>");
    public final static String GUILD_OFFLINE = EmojiParser.parseToUnicode("<:Offline:311276612307910657>");
    public final static String GUILD_STREAMING = EmojiParser.parseToUnicode("<:Streaming:311276612861820938>");
